...
# https://www.researchgate.net/publication/235325100_Airport_capacity_and_demand_calculations_by_simulation-the_case_of_Berlin-Brandenburg_International_Airport

np.random.seed(42)  # For reproducibility, generally used in programming
demands = []
# simulates how many passengers want to take each flight using 80% of the plane’s capacity, with random variation
